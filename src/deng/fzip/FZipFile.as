package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_557:int = 8;
      
      public static const const_1440:int = 10;
      ...
      public static const const_1509:int = 9;
      ...
      private var var_1448:String = "2.0";
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_662 = ChecksumUtil.CRC32(var_33);
            var_478 = false;
         }
         compress();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1223 << 8 | 20);
         }
         else
         {
         ...
         param1.writeUnsignedInt(var_559);
         var _loc8_:ByteArray = new ByteArray();
         _loc8_.endian = Endian.LITTLE_ENDIAN;
         if(var_341 == "utf-8")
         {
            _loc8_.writeUTFBytes(var_392);
         }
         else
         {
            _loc8_.writeMultiByte(var_392,var_341);
         }
         ...
         if(param2)
         {
            if(!var_478)
            {
               ...
               var_800 = ChecksumUtil.Adler32(var_33,0,var_33.length);
               var_478 = true;
               if(_loc16_)
               {
                  compress();
            ...
            _loc8_.writeShort(4);
            _loc8_.writeUnsignedInt(var_800);
         }
         ...
         if(param3 && false)
         {
            if(var_341 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_1990);
            }
            else
            {
               _loc8_.writeMultiByte(var_1990,var_341);
            }
         }
      ...
      {
         if(param1.bytesAvailable >= var_989 + var_1224)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_341 == "utf-8")
         {
            var_392 = param1.readUTFBytes(var_989);
         }
         else
         {
            var_392 = param1.readMultiByte(var_989,var_341);
         }
         var _loc2_:uint = var_1224;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               throw new Error("Parse error in file " + var_392 + ": Extra field data size too big.");
            }
            if(_loc3_ === 56026 && _loc4_ === 4)
            {
               var_800 = param1.readUnsignedInt();
               var_478 = true;
            }
            else if(_loc4_ > 0)
            {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1223 = _loc2_ >> 8;
         var_1448 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_661 = param1.readUnsignedShort();
         var_1450 = (_loc3_ & 1) !== 0;
         var_1449 = (_loc3_ & 8) !== 0;
         var_1988 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_341 = "utf-8";
         }
         if(var_661 === const_1240)
         {
            var_2206 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2207 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_661 === const_557)
         {
            var_1989 = (_loc3_ & 6) >> 1;
         }
         ...
         var_559 = param1.readUnsignedInt();
         var_989 = param1.readUnsignedShort();
         var_1224 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_392 + "\n  date:" + var_663 + "\n  sizeCompressed:" + var_175 + "\n  sizeUncompressed:" + var_559 + "\n  versionHost:" + var_1223 + "\n  versionNumber:" + var_1448 + "\n  compressionMethod:" + var_661 + "\n  encrypted:" + var_1450 + "\n  hasDataDescriptor:" + var_1449 + "\n  hasCompressedPatchedData:" + var_1988 + "\n  filenameEncoding:" + var_341 + "\n  crc32:" + var_662.toString(16) + "\n  adler32:" + var_800.toString(16);
      }
