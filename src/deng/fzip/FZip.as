package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_423 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         if(var_423.parse(param1))
         {
            var_52.push(var_423);
            if(false)
            {
               var_126["null"] = var_423;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1119,var_423));
            var_423 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_52 != null && var_126 != null && param1 < var_52.length)
         {
