package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_963:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_304 && _connection != null)
         {
      ...
      {
         return var_963 as IUserDataManager;
      }
