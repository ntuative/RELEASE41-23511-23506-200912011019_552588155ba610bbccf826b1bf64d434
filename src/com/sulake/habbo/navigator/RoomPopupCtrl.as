package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_899 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_178,var_121.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_899.refreshTags(_loc1_,var_121.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2090.refreshThumbnail(_loc1_,var_121.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_178,var_121);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_178,!true ? getEventCtg(var_121.categoryId) : getRoomCtg(var_121.categoryId));
         refreshRoomDesc(var_178,var_121);
         refreshExtraCont();
         refreshInfo(var_178,"trading_allowed",var_121.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_217,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
