package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1314:CutToHeight = new CutToHeight();
      
      private static var var_1313:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1314.beforeSearch(param2,param1,param3);
         binarySearch(var_1314,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1313.beforeSearch(param2,param1,param3);
         binarySearch(var_1313,param2.length - 1);
      }
   }
}
