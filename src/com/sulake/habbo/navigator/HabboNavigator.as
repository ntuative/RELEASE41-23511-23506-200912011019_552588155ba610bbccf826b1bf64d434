package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_340:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_2115:ISessionDataManager;
      ...
      private var var_487:MainViewCtrl;
      
      private var var_2113:Array;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_487 = new MainViewCtrl(this);
         var_1268 = new RoomInfoViewCtrl(this);
         var_2114 = new RoomCreateViewCtrl(this);
         var_2090 = new RoomThumbnailRenderer(this);
         var_922 = new GuestRoomPasswordInput(this);
         var_340 = new GuestRoomDoorbell(this);
         var_403 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_487.startSearch(Tabs.const_190,Tabs.const_323,param1);
         var_487.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_205 != null)
         {
            var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2115 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_487.startSearch(Tabs.const_269,Tabs.const_214);
         var_403.getTab(Tabs.const_269).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_487.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
