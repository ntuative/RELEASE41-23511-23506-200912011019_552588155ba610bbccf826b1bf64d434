package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1290:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_306:
      ...
      private function onError(param1:IMessageEvent) : void
      {
         ...
         {
            case -100002:
               _navigator.passwordInput.method_7();
         }
      }
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_155)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_104)
            {
