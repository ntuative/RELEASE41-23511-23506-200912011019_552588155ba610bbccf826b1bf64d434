package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_93.mode != ThumbnailEditorModel.const_34);
         setEnabled(var_1355,this.var_93.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1354,this.var_93.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_93.mode = ThumbnailEditorModel.const_34;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_93.mode = ThumbnailEditorModel.const_51;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1355 = IButtonWindow(find("top_tab"));
         var_1354 = IButtonWindow(find("obj_tab"));
         ...
         Util.setProcDirectly(var_1355,onTopTabButton);
         Util.setProcDirectly(var_1354,onObjTabButton);
      }
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_93.mode = ThumbnailEditorModel.const_31;
         this.reload();
      }
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,param1.width,66)));
