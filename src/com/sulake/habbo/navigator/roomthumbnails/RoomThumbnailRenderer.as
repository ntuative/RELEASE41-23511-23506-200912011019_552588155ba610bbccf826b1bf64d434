package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_738:int = 32;
      
      private static const const_1047:int = 8;
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1049,_loc4_.y + const_1048 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1780[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_752.getImage(ThumbnailEditorModel.const_34,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_752.getImage(ThumbnailEditorModel.const_34,1);
         }
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_738 / 2);
         return new Point(param1 * const_738 + _loc3_,param2 * const_1047);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1143 == null)
         {
            var_1143 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1143,var_1143.rect,new Point(0,0),null,null,true);
      }
   }
}
