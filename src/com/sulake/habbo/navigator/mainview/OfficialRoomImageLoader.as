package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomImageLoader implements IDisposable
   {
      ...
      private function onImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         Logger.log("IMAGE READY: " + var_751 + ", " + _loc2_);
         setImage();
      }
      ...
      public function startLoad() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         if(_navigator.assets.hasAsset(var_751))
         {
            setImage();
         }
         else
         {
            ...
            _loc2_ = _navigator.assets.loadAssetFromFile(var_751,_loc1_,"image/gif");
      ...
      {
         var _loc1_:BitmapData = _navigator.getButtonImage(var_751,"");
         var_624.bitmap = _loc1_;
         var_624.width = _loc1_.width;
         var_624.height = _loc1_.height;
