package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private var var_631:IWindowContainer;
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         var_454 = new Timer(const_1058,1);
         var_454.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_372.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_372.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_644)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_454 != null)
            {
               var_454.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_454.stop();
               var_454 = null;
            }
            if(var_135 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         if(var_631 == null)
         {
            var_631 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_631.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_222:
               ...
               break;
            case InventorySubCategory.const_949:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
         ...
         if(param1 == InventoryCategory.const_72 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_296:
                  _controller.toggleInventoryPage(InventoryCategory.const_161);
            }
         }
      }
      ...
      {
         if(var_757 && param1.type == RoomEngineObjectEvent.const_208)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_299 || _loc3_.category == FurniCategory.const_316 || _loc3_.category == FurniCategory.const_302)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_372.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_372 = new Map();
         var_372.add(const_41,new Array());
         var_372.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
