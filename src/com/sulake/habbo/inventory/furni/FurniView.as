package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1572:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param4;
         var_437 = new Map();
         var_437.add(FurniModel.const_41,new FurniGridView(var_93,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_437.add(FurniModel.const_42,new FurniGridView(var_93,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  method_2(FurniModel.const_42);
                  break;
               case "tab_pets":
                  method_2(FurniModel.const_296);
            }
         }
      }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = var_437.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function method_2(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_437.getValue(var_436);
         if(_loc4_ != null)
         {
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = var_437.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_93.getGroupItemInIndex(_loc3_,var_436);
      ...
      {
         var _loc3_:FurniGridView = var_437.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
