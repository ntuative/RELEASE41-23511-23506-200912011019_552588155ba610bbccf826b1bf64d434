   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_52)
         {
            ...
            var_93.toggleItemSelection(_category,var_482.getGridItemIndex(param1.window));
            var_343 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_28 && var_343 != null && var_343 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_251)
         {
