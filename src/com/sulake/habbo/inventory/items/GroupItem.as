package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2147:BitmapData;
      ...
      private const const_1357:Number = 0.2;
      
      protected var var_1289:Boolean;
      
      private const const_1358:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_644)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2148 == FurniModel.const_41)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1293);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1357;
               _loc1_.blend = const_1357;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(var_1289 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2147;
               _loc5_.visible = true;
            }
            else
            {
