package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_161 && false)
         {
      ...
      {
         _controller.furniModel.method_2(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1253 && param1.type == RoomEngineObjectEvent.const_208)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1253 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_36,RoomObjectTypeEnum.const_293,_loc3_.figure);
      ...
      {
         if(var_944.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
