package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1570:int = 500;
      ...
      private var var_1340:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_86,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_403,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_403:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_59.getValue(InventoryCategory.const_577));
      }
      ...
      {
         var_186.clubPeriods = param1;
         var_186.clubDays = param2;
         var_186.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_868));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_59.getValue(InventoryCategory.const_161));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1570);
         }
      }
      ...
      {
         return AchievementsModel(var_59.getValue(InventoryCategory.const_283));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_810.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_810.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_59.getValue(InventorySubCategory.const_222));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_531 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_810.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1340 = new IncomingMessages(this);
      ...
      {
         return var_186.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_186.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_59.getValue(InventoryCategory.const_223));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_86,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_403,roomSessionEventHandler);
         ...
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_531);
         var_59.add(InventoryCategory.const_223,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_59.add(InventoryCategory.const_577,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_531);
         var_59.add(InventoryCategory.const_283,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_59.add(InventorySubCategory.const_222,_loc7_);
         ...
         var_59.add(InventoryCategory.const_161,_loc9_);
