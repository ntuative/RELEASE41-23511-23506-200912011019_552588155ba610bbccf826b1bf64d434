package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_97 = var_538.height;
         var_947 = param5;
         var_761 = param6;
         var_219 = Math.floor(var_947 / _thumbWidth);
         var_32 = new BitmapData(var_947,var_761);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_761)
         {
            _loc12_ = new BitmapData(var_32.width,var_761);
      ...
      public function updateImageFromList() : void
      {
         ...
         var_32 = new BitmapData(Math.max(var_219 * _thumbWidth,var_947),Math.max(var_457 * var_97,var_761),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_219 && var_32.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(_thumbWidth * (var_219 - 1),0,_thumbWidth,var_32.height);
