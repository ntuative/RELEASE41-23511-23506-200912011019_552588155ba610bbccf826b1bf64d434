package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1154:ProfilerAgentTask;
      
      private var var_1155:IEventDispatcher;
      
      private var var_2243:uint = 0;
      
      private var var_1157:ProfilerAgentTask;
      
      private var var_1156:ProfilerOutput;
      
      private var var_630:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_194 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1155 = Component(param1).events;
            var_756 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_630 = new WindowRenderer(_loc4_);
         var_288 = new Array(const_335);
         var _loc6_:int = 0;
         while(_loc6_ < const_335)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_630,this,_localization,var_194,new Rectangle(0,0,var_194.stageWidth,var_194.stageHeight),this);
            var_288[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_370 = var_288[const_1057];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_370.getMouseCursor().defineCustomCursorType(MouseCursorType.const_326,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_370.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1203,_loc7_);
      }
      ...
      {
         return var_288[param1].getDesktopWindow().getChildAt(var_370.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1156 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1156 = new ProfilerOutput(_loc3_,this,var_630);
               var_1154 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1154);
               var_1157 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1157);
               var_943 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1155.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_335 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1155.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         var_1155.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_756[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_756[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1118,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1186,new Date().getTime().toString());
