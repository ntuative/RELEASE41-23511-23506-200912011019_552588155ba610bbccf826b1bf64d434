package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1014:int = 20;
      
      private static const const_731:int = 100;
       
      
      private var var_1692:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_144 = param1;
         var_1348 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1692 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_685)
         {
            return 4285887861;
         }
         if(param1 == Message.const_517)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_659 || param3.type == Message.const_617 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_439.messages.length - const_731);
         _loc1_ = 0;
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_731 + const_1014)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_144.send(new FollowFriendMessageComposer(var_439.id));
      }
