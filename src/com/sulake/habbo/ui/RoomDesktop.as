package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_227:DesktopLayoutManager;
      ...
      private var var_1966:IHabboHelp = null;
      ...
      private var var_789:IRoomWidgetFactory = null;
      ...
      private var var_1105:IAvatarRenderManager = null;
      ...
      private var var_531:ISessionDataManager = null;
      
      private var var_1973:uint = 16777215;
      
      private var var_71:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_226 = new Map();
         var_227 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_372,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_653,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_658 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_475 != null && true)
         {
            var_1214 = !var_475.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_263[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_226 != null)
         {
            ...
            {
               _loc5_ = var_226.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_372,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_653,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_789 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1973);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_226.length)
         {
            _loc2_ = var_226.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_227.setLayout(param1,_windowManager);
         if(var_205 != null)
         {
            var_227.toolbarSize = var_205.size;
            var_227.toolbarOrientation = var_205.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_789.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_227.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_226.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_227.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_227 != null)
         {
            var_227.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_530:
               ...
               if(var_1432 != null && _loc3_ == RoomObjectCategoryEnum.const_36)
               {
                  _loc7_ = var_47.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_377)
                  {
                     var_1432.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_250:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_416:
               ...
               break;
            case RoomEngineObjectEvent.const_85:
               processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_226.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_227.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_532);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_611);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_646);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_515);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_186);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_393:
               ...
               var_172 = _windowManager.createWindow("room_ad_tooltip","${ads.roomad.tooltip}",WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_230,WindowParam.const_79) as IToolTipWindow;
               var_172.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_658 == null || false)
         {
            return;
         }
         var _loc2_:int = var_658.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_34 != null && var_47 != null && var_1214 && var_9)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_227.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
