package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_678,RoomWidgetEcotronBoxOpenMessage.const_680,RoomWidgetEcotronBoxOpenedMessage.const_1099];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_678:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_680:
