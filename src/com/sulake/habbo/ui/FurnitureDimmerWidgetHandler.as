package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_441:
               _loc2_ = param1 as RoomSessionDimmerPresetsEvent;
               _loc3_ = new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_689);
               _loc3_.selectedPresetId = _loc2_.selectedPresetId;
               _loc6_ = 0;
               while(_loc6_ < _loc2_.presetCount)
               {
                  _loc7_ = _loc2_.method_4(_loc6_);
                  if(_loc7_ != null)
                  {
            ...
            case RoomEngineObjectEvent.const_85:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_930));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_493,RoomWidgetDimmerSavePresetMessage.const_600,RoomWidgetDimmerChangeStateMessage.const_501,RoomWidgetDimmerPreviewMessage.const_560];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_493:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_600:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_501:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_560:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_441);
         _loc1_.push(RoomEngineDimmerStateEvent.const_58);
         _loc1_.push(RoomEngineObjectEvent.const_85);
         return _loc1_;
      }
