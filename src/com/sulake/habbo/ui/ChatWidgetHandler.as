package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_715:Number = 0;
      
      private var var_427:Point = null;
      
      private var var_595:Map = null;
      
      private var var_425:Vector3d;
      ...
      public function dispose() : void
      {
         ...
         if(var_426 != null)
         {
            ...
            {
               _loc2_ = var_426.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_426.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_595.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_293:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_91);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_91);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_426.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_595.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_686,RoomWidgetChatSelectAvatarMessage.const_633];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_686:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_137,_container.roomSession,0,"Version 23511-23506-200912010939");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_297);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_376);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_715 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_715);
            }
            if(var_427 == null)
            {
               var_425.x = 0;
               var_425.y = 0;
               var_425.z = 0;
               var_427 = _loc4_.getScreenPoint(var_425);
               var_715 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_425.x = 0;
            var_425.y = 0;
            var_425.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_425);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_427.x || _loc8_.y != var_427.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_427,_loc5_));
