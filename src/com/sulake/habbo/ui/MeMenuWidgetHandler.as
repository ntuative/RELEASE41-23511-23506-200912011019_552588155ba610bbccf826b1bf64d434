   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_929,HabboToolbarIconEnum.MEMENU);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_468:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_462));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_700,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_468,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_700,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_868,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_681,onHabboClubSubscriptionChanged);
         }
         var_205 = _container.toolbar;
         if(var_205)
         {
            var_205.events.addEventListener(HabboToolbarEvent.const_80,onHabboToolbarEvent);
            var_205.events.addEventListener(HabboToolbarEvent.const_62,onHabboToolbarEvent);
            setMeMenuToolbarIcon(false);
         }
         if(false)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_468,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_97,onHelpTutorialEvent);
         }
         var_71 = _container.catalog;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_683);
         _loc1_.push(RoomWidgetDanceMessage.const_699);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_626);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_496);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_597);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_664);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_612);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_696);
         _loc1_.push(RoomWidgetStopEffectMessage.const_507);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1149);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_774);
         _loc1_.push(RoomWidgetToolbarMessage.const_566);
         ...
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_957);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_587);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_494);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_667);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_538);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1267);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_497);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_652);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_520));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_494:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetWaveMessage.const_683:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_699:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_626:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_496:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_597:
               if(var_28 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_696:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_71 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_573)
               {
                  var_71.openCatalogPage(CatalogPageName.const_319,true);
               }
               break;
               ...
               if(var_28 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_830:
                        var_71.openCatalogPage(CatalogPageName.const_1337,true);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_507:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_977:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_774:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_587:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_566:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_205)
               {
                  var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_614:
               ...
               if(var_205)
               {
                  var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_345,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_624:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_431,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_961));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_431,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1124));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_655));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_667:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_538:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_497:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_317,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_652:
            ...
            case RoomWidgetAvatarEditorMessage.const_688:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_606));
               }
               break;
            default:
