package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2025:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_448,0,0,_loc4_,var_1467,var_2025,var_2027));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2026 = int(_config.getKey("interstitial.interval","30000"));
         var_2028 = int(_config.getKey("interstitial.show.time","5000"));
         var_1469 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1467 = _loc2_.clickUrl;
         if(var_1243 != "" && var_1467 != "")
         {
            _loc3_ = var_1243;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1244 = _loc2_.imageUrl;
         var_2024 = _loc2_.clickUrl;
         var_671 = getTimer();
         if(var_1244 != "")
         {
            _loc3_ = var_1244;
            ...
            var_232.start();
            _loc4_ = new URLRequest(var_1244);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_408,0,0,param1.bitmapData,var_2024));
            var_671 = getTimer();
         }
         else
         {
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1469 > 0 && var_1468 >= var_1469)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_671;
         if(_loc1_ > var_2026)
         {
            ++var_1468;
      ...
      {
         var_618 = param2 as IHabboCommunicationManager;
         if(var_618 == null)
         {
            return;
         }
         _connection = var_618.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2025 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
