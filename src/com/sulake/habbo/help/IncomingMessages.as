package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_43.tellUI(HabboHelpViewEnum.const_205,_loc4_);
         }
      }
      ...
      {
         var_43.showUI(HabboHelpViewEnum.const_276);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_461);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_669);
         var_43.tellUI(HabboHelpViewEnum.const_669,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_377)
            {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_544);
      }
