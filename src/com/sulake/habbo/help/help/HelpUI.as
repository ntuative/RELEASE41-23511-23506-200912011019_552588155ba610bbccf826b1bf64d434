package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1360:int = 0;
      ...
      private var var_1746:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23511-23506-200912010939");
         var_205 = param5;
         var_107 = new Map();
         var_107.add(HabboHelpViewEnum.const_1330,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_131,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_461,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_260,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_205,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_669,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_276,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_716,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_189,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_107.add(HabboHelpViewEnum.const_783,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_107.add(HabboHelpViewEnum.const_544,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1376 = 0 - _loc3_.width;
         var_1375 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_131 || false)
         {
            return;
         }
         if(var_367 == null)
         {
            ...
            var_367 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_367 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_367 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_367 as IWindow);
      ...
      {
         return var_107.getValue(var_252);
      }
      ...
      {
         var_1744 = param1;
         var _loc2_:IHelpViewController = var_107.getValue(HabboHelpViewEnum.const_131) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_189:
               showUI(HabboHelpViewEnum.const_189);
               break;
            case CallForHelpResultEnum.const_920:
               showUI(HabboHelpViewEnum.const_783);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_131)
         {
            return;
         }
         if(true)
         {
            ...
            var_522.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_522.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_367.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_522[1],var_522[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_522[0],var_522[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1375;
         _window.width = _loc1_.width + var_1376;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_205 != null)
            {
               var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_663));
      }
