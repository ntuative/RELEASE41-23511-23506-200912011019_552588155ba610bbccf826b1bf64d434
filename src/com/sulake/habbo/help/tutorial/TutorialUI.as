package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_55 = param1;
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_663,onTaskDoneEvent);
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_655,onTaskDoneEvent);
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_606,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_55.hideUI();
         var_55.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_97));
      }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1375;
         _window.width = _loc2_.width + var_1376;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_663:
               var_950 = true;
               if(var_40 != null && var_40.id == const_356)
               {
                  showView(const_81);
               }
               break;
            case HabboHelpTutorialEvent.const_655:
               if(var_40 != null && var_40.id == const_285)
               {
                  var_1161 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_606:
               if(var_1161)
               {
                  var_1161 = false;
                  showView(const_81);
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_857)
         {
            showView(const_243);
      ...
      {
         var_951 = true;
         if(var_40 != null && (var_40.id == const_285 || var_40.id == const_81))
         {
            showView(const_81);
         }
      }
      ...
      {
         return var_951 && var_949 && var_950;
      }
   }
}
