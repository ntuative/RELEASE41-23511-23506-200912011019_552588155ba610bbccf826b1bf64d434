package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_181:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_844 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_181.duration);
               var_844.width = _loc2_ * var_411;
            }
            else
            {
               var_844.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_843 = _window.findChildByName("effect_hilite");
            var_843.visible = false;
         }
         var_842 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_844 = _window.findChildByName("loader_bar");
         if(var_844 != null)
         {
            var_411 = var_844.width;
            var_166.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_181.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_842 != null)
         {
            var_842.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_842.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
