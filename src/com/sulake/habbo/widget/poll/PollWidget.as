package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      private function showPollOffer(param1:Event) : void
      {
         ...
         var _loc3_:PollSession = var_260.getValue(_loc2_) as PollSession;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_115,showPollContent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_115,showPollContent);
      }
      
      public function pollFinished(param1:int) : void
      {
         var _loc2_:PollSession = var_260.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
            var_260.remove(param1);
         }
      }
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = var_260.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_260)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_260.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
