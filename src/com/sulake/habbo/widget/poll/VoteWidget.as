package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_695:Array = null;
      ...
      private var var_1140:int = 30000;
      
      private var var_1142:Boolean = false;
      
      private var var_937:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1140 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_111,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_114,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_282,update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_111,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_114,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_282,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1140 - param1) / 1000,0);
