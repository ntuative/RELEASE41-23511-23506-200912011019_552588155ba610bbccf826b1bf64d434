package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_41 = param3;
         var_2044 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1473 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_2045 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1475 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1474 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_2042 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_2047 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_79 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,param3.width,param3.height - const_71),null,0,0) as IBitmapWrapperWindow;
         var_41.addChild(var_79);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_56,HabboWindowStyle.const_39,HabboWindowParam.const_35,new Rectangle(0,0 - const_71,param3.width,const_71),null,0) as IWindowContainer;
         var_41.addChild(_window);
         var_101 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_370,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_71),null,0) as IRegionWindow;
         if(var_101 != null)
         {
            var_101.background = true;
            var_101.alphaTreshold = 0;
            var_101.addEventListener(WindowMouseEvent.const_52,onPulldownMouseDown);
            var_41.addChild(var_101);
      ...
      public function update(param1:uint) : void
      {
         switch(state)
         {
            case const_418:
               ...
               break;
            case const_762:
               var_79.blend = 0 - param1 / const_758;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_101 != null)
         {
            ...
            var_101.width = 0 - var_2046;
         }
         if(var_79 != null)
         {
            var_79.rectangle = var_41.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_2043 == _window.width)
         {
            return;
         }
         var_2043 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_2044.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1473.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1473.clone(),_loc9_);
