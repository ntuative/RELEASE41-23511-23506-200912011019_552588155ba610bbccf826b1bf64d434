package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1363:Number = 10;
      
      private static const const_1362:Number = 8;
       
      
      private var var_1133:Number;
      ...
      {
         _widget.onItemMouseOut(var_925,var_926,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_925,var_926,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1132 = param1.chatType;
         var_925 = param1.userId;
         var_747 = param1.userName;
         var_926 = param1.userCategory;
         _message = param1.text;
         var_1133 = param1.userX;
         var_192 = param1.userImage;
         var_927 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_192 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_368 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_927 != 0)
            {
               _loc31_ = uint(var_927 >> 16 & 255);
               _loc32_ = uint(var_927 >> 8 & 255);
               _loc33_ = uint(var_927 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_334;
            }
            else
            {
               _loc19_.text = var_747 + ":";
               _loc19_.y += var_368;
               _loc19_.width = _loc19_.textWidth + const_334;
               _width += _loc19_.textWidth + const_334;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1132 == RoomWidgetChatUpdateEvent.const_254)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_747);
            }
            else if(var_1132 == RoomWidgetChatUpdateEvent.const_253)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_747);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_334 + _loc20_.textWidth + const_478;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_925,var_926,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_925,var_926,_roomId,_roomCategory,param1);
      }
