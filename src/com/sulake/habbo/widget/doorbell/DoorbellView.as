package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      private var var_340:DoorbellWidget;
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_340.assets.getAssetByName("doorbell") as XmlAsset;
         var_58 = (var_340.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_58 == null)
         {
      ...
      public function update() : void
      {
         ...
         if(_list != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_340.users.length)
            {
               _list.addListItem(createListItem(var_340.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_340.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = (var_340.windowManager as ICoreWindowManager).buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
