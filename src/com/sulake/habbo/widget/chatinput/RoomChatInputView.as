package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_334:int = 10;
      ...
      private var var_452:Boolean = false;
      
      private var var_411:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_938 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1788 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1786 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_627 = new Timer(1000,1);
         var_627.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_755 = new Timer(5000,1);
         var_755.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_56,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_235,onInputChanged);
         _window.addEventListener(WindowEvent.const_400,onWindowMoved);
         var_1151 = true;
         var_133 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1787 = _loc2_.width + const_478 + _loc6_.width + const_1053;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1052,_loc8_.width) + const_478);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_938 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_133 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_411);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_411);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_452);
