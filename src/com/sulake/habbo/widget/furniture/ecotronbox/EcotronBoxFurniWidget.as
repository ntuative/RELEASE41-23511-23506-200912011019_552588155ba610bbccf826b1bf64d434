package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc1_:* = null;
         if(var_218 || var_155 == -1 || !_controller)
         {
            return;
         }
         var_218 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_680,var_155);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_56,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1056,const_1055,2,2),null,0) as IWindowContainer;
