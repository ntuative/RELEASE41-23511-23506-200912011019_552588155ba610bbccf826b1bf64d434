package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1568:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1566:String = "level";
      ...
      private const const_1567:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1564:uint = 3355443;
      ...
      private const const_1560:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_214 != null)
         {
            var_106 = var_214.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_106 == null || var_214 == null || var_65 == null)
         {
            return;
         }
         ...
         var_214.height = NaN;
         _window.width = Math.max(var_214.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1229.getValue(var_628) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1566,param1.level,param1.levelMax);
         ...
         updateStateElement(const_1567,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_628 = param1.id;
         var_1229.remove(param1.id);
         var_1229.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_429,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1565,const_1562,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1560);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1564);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1568);
         return _loc5_;
      }
