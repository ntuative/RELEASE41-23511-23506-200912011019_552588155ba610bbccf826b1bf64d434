package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_328:IFrameWindow;
      
      private var _widget:InfostandWidget;
      
      private var var_940:Map;
      
      private const const_1552:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         _widget = param1;
         var_940 = new Map();
         var_327 = new Timer(const_1552);
         var_327.addEventListener(TimerEvent.TIMER,onButtonDisableTimeout);
      }
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_645,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(var_328 == null)
         {
            ...
            var_328 = (_widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(var_328 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            var_328.x = 200;
            var_328.procedure = onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_362,var_628));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_502,var_628,var_1792 + " " + _loc6_);
      ...
      private function createCommandWindow() : void
      {
         ...
         var_48.setParamFlag(WindowParam.const_79,true);
