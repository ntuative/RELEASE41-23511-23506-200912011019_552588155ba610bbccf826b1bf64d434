package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1550:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1100 != null && var_1100.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_733 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_733 += param1.height + const_1550;
            return fit(param1);
         }
         param1.offset(_offsetX,var_733);
         _offsetX += param1.width + const_1549;
         return true;
      }
