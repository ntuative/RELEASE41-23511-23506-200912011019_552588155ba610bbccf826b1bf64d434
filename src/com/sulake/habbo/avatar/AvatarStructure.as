package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_364:PartSetsData;
      
      private var var_1707:PartOffsetData;
      ...
      private var var_1357:AvatarStructureDownloadSet;
      
      private var var_738:AvatarActionManager;
      
      private var var_153:IAssetLibrary;
      
      private var var_440:FigureData;
      
      private var var_2174:IAssetLibrary;
      
      private var var_1288:Boolean = false;
      
      private var var_613:AnimationManager;
      
      private var var_1706:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_364 = new PartSetsData();
         _animationData = new AnimationData();
         var_1357 = new AvatarStructureDownloadSet();
         var_613 = new AnimationManager();
         var_737 = param4;
         var_1707 = PartOffsetData.getInstance(param3);
      }
      
      public function getBodyParts(param1:String, param2:IActionDefinition, param3:int) : Array
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1106[param3];
      ...
      {
         return var_738.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_613.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_737)
         {
            case AvatarType.const_96:
               _loc3_ = var_153.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_364.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_153.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_153.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_440.parse(_loc5_))
               {
                  return;
               }
               var_1357.add(new AvatarStructureDownload(var_153,_loc2_,var_440));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_153.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_364.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_153.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_153.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_440.parse(_loc5_))
               {
                  return;
               }
         ...
         if(_loc6_)
         {
            var_1357.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
         }
         else
         {
            onStructureReady();
      ...
      {
         return var_738.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_738.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_738 = new AvatarActionManager(var_153,var_737);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_613.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_364.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_364.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_738.getDefaultActionType();
         var _loc7_:Array = var_364.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_613.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            if(_loc23_ != null)
            {
               _loc24_ = var_440.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_364.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_364.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_153.hasAsset("dance" + _loc1_))
         {
            ...
            var_613.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_440.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_440.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_737 + " ready to go!");
         if(var_737 == AvatarType.const_96)
         {
            var_364.getPartDefinition("ri").appendToFigure = true;
            var_364.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      {
         return var_738.sortActions(param1);
      }
   }
}
