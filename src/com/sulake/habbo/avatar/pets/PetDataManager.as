package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_562.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_562.getValue(param1) as IPetData;
      }
      ...
      public function createAvatarFigureString(param1:String) : String
      {
         ...
         var _loc6_:PetData = var_562.getValue(_loc3_);
         if(_loc6_ == null)
         {
      ...
      {
         var _loc4_:PetData = var_562.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_562.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_562.getValue(key);
            if(petData != null)
            {
