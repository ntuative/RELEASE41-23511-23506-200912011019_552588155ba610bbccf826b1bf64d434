package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1330:PaletteManager;
      
      private var var_873:CoreComponent;
      
      private var var_1331:ILogger;
      
      private var var_1067:PetDataManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            var_873 = CoreComponent(param1);
            var_873.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_503.getValue(AvatarType.const_96) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
         _loc2_ = var_503.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
      ...
      {
         return var_1067 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_503.getValue(AvatarType.const_96) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_29,param1,param2,AvatarType.const_96);
      }
      
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         var _loc5_:String = var_1067.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_503.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:AssetLibraryCollection = var_873.assets as AssetLibraryCollection;
         var _loc3_:int = 0;
         ...
         var_1067 = new PetDataManager(_loc2_,_loc4_);
         var_1330 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1067.populateFigureData(_loc5_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.const_96);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_503.add(AvatarType.const_96,_loc6_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.PET);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_503.add(AvatarType.PET,_loc6_);
      ...
      {
         var _loc2_:AvatarStructure = var_503.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1330.getPalette(0);
