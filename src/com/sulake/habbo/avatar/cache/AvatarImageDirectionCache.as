package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageDirectionCache
   {
      ...
      public function getImageContainer(param1:int) : AvatarImageBodyPartContainer
      {
         ...
         return var_706[_loc2_];
      }
      
      public function method_13(param1:Array) : Boolean
      {
         var _loc3_:int = 0;
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:Boolean = true;
         if(var_610.length == param1.length)
         {
            _loc3_ = 0;
            while(_loc3_ < var_610.length)
            {
               _loc4_ = var_610[_loc3_];
               _loc5_ = var_610[_loc3_];
               if(_loc4_ != _loc5_)
               {
                  _loc2_ = false;
                  break;
