package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      private var var_769:Dictionary;
      
      public function PartSetsData()
      {
         super();
         var_545 = new Dictionary();
         var_769 = new Dictionary();
      }
      ...
      {
         var _loc2_:ActivePartSet = var_769[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_769[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_769[param1.activePartSet] as ActivePartSet;
      }
