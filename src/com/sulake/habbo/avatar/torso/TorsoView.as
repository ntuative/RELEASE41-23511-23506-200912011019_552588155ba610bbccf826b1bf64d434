package com.sulake.habbo.avatar.torso
{
   ...
   public class TorsoView implements IAvatarEditorCategoryView
   {
      ...
      public function TorsoView(param1:TorsoModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_129,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.CHEST_ACCESSORIES,param2,param3);
         attachImages();
         method_2(FigureData.const_129);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_accessories":
                  method_2(FigureData.CHEST_ACCESSORIES);
            }
         }
