package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_55,param2,param3);
         attachImages();
         method_2(FigureData.const_55);
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_93.categorySwitch(FigureData.const_77);
                  param1.stopPropagation();
                  break;
               case "tab_girl":
                  var_93.categorySwitch(FigureData.const_78);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_666[param1];
         if(_loc4_ != null)
         {
      ...
      public function method_2(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_666[var_1430];
         if(_loc4_ == null)
         {
            return;
         }
