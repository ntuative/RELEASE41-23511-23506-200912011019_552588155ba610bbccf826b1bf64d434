package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_164,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_133,param2,param3);
         attachImages();
         method_2(FigureData.const_132);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_pants":
                  ...
                  break;
               case "tab_shoes":
                  method_2(FigureData.const_164);
                  break;
               case "tab_belts":
                  method_2(FigureData.const_133);
            }
         }
