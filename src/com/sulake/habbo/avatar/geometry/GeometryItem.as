package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      public function GeometryItem(param1:XML, param2:Boolean = false)
      {
         ...
         var_1283 = parseFloat(param1.@radius);
         var_404 = new Vector3D(parseFloat(param1.@nx),parseFloat(param1.@ny),parseFloat(param1.@nz));
         var_1712 = parseInt(param1.@double) as Boolean;
         var_1711 = param2;
      }
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1283);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1283);
