package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_122,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_147,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_130,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_127,param2,param3);
         var_666["null"] = new AvatarEditorGridView(param1,FigureData.const_146,param2,param3);
         attachImages();
         method_2(FigureData.const_122);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  method_2(FigureData.const_147);
                  break;
               case "tab_accessories":
                  method_2(FigureData.const_130);
                  break;
               case "tab_eyewear":
                  method_2(FigureData.const_127);
                  break;
               case "tab_masks":
                  method_2(FigureData.const_146);
            }
         }
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1032);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_666[var_1430];
         if(_loc2_ == null)
         {
            return;
         }
