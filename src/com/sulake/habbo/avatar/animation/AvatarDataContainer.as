package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1435,var_1434,var_1438,_alphaMultiplier);
         var_1013 = generatePaletteMapForGrayscale(var_2116,var_2118);
      }
      
      public function get reds() : Array
      {
         return var_1013.getValue("reds") as Array;
      }
      ...
      {
         return var_1013.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1013.getValue("greens") as Array;
      }
      ...
      {
         return var_1013.getValue("alphas") as Array;
      }
