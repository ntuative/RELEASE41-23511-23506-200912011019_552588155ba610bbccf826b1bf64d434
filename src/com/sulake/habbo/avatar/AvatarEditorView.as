package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1284:IWindowContainer;
      
      public static var var_1032:int = 6710886;
       
      
      private var var_1391:Boolean = true;
      
      private var var_166:Timer;
      
      private var var_1392:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1284 == null)
         {
            ...
            var_1284 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1511 == null)
         {
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_686 != null)
         {
            toggleCategoryView(var_686,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1392 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_686 = param1;
         var_1392.setSelected(var_1392.getSelectableByName(param1));
         _window.invalidate();
      }
