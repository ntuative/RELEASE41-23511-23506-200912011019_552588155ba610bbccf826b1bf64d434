package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1315 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_91);
         var_1315.setDirection(AvatarSetType.const_38,int(FigureData.const_844));
         _image = var_1315.getImage(AvatarSetType.const_38);
         _view.udpate(_image);
      }
