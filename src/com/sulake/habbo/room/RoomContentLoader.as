package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_742:String = "selection_arrow";
      
      private static const const_743:String = "tile_cursor";
      ...
      private static const const_336:String = "place_holder";
      
      private static const const_1062:String = const_336;
      ...
      public static const const_648:String = "RCL_LOADER_READY";
      ...
      private var var_956:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_641 = [];
         var_642 = [];
         var_1851 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1853 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_378 = new Map();
         _events = new Map();
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_124 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_169 != null && var_169.hasWorldType(const_271 + param1))
         {
            return var_169.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_642.indexOf(_loc14_) < 0)
                              {
                                 var_642.push(_loc14_);
                              }
                           }
                           _loc16_ = var_463.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_463.remove(_loc14_);
                              var_463.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_333 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_333.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_336,const_481,ROOM_CONTENT,const_743,const_742];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_33 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_463.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1851.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_152 && _loc5_ != RoomObjectLogicEnum.const_124)
         {
            _loc6_ = "@shadow";
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1339);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1853.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_372,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_169 != null && (var_169.type == param1 || var_169.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_53;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_53;
      ...
      private function continueInitilization() : void
      {
         if(var_1850)
         {
            ...
            if(var_956 != null)
            {
               var_956.dispatchEvent(new Event(const_648));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_169 != null)
         {
            return var_169.getWorldHeightScale(const_271 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_956 = param1;
            var_1854 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1852 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1855 = param2.getKey("public.room.dynamic.download.url","");
            var_1849 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_741;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_333.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_152 && _loc5_ != RoomObjectVisualizationEnum.const_124)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_374.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_271 + param1) == RoomObjectCategoryEnum.const_53)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_169 = _publicRooms.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_426,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_169 != null)
         {
            return var_169.getWorldScale(const_271 + param1);
         }
         return 32;
      }
