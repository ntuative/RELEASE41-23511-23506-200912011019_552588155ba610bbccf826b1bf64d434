package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1378:int = 0;
      ...
      private const const_1559:int = 2;
      
      private var var_780:AvatarVisualizationData = null;
      ...
      {
         var_780 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_384.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_162);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_500);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_640);
         ...
         var _loc13_:Number = _loc7_ - var_1267;
         ...
         var _loc19_:Boolean = var_275 != _loc2_.getUpdateID() || var_207 != param1.scale || var_184 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_485 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_485;
            _loc22_ = getTimer();
            if(var_514 != _loc6_)
            {
               for each(_loc48_ in var_384.getKeys())
               {
                  var_384.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_780.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_384.remove(_loc4_);
               var_384.add(_loc4_,_loc5_);
               var_514 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_278);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_244) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_244);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_601);
            _loc5_.appendAction(AvatarAction.const_552,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_446);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_386);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_305,AvatarAction.const_1154[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_943);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_953,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_925);
            if(_loc30_ > 0)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_880,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_630);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_622);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_855,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_837);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_839,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_466);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_355) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_582);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_347);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_768);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_720,_loc35_);
            }
            ...
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_786))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_780.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
