package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_996:Number = 30;
      ...
      {
         var_586 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1283 = param3;
         var_1561 = param4 * 0 * 2 / 360;
         var_1306 = param5 * 0 * 2 / 360;
         _height = param6;
         var_707 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1283 * Math.cos(var_707 + var_1306);
         var _loc4_:Number = var_1283 * Math.sin(var_707 + var_1306);
         var _loc5_:Number = _height;
         var_586.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_586.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_586.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_586.add(param1);
         }
