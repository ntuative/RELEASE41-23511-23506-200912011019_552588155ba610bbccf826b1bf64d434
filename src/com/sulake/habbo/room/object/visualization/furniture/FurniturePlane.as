package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_567:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_568 = new Vector3d();
         var_568.assign(param2);
         var_567 = new Vector3d();
         var_567.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2107)
         {
            if(!param1)
            {
               var_270.assign(var_568);
               var_269.assign(var_567);
            }
            else
            {
               var_270.assign(var_568);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_78 == null && var_679 != null || var_270 == null || var_269 == null || var_404 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1262)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1010 || _loc4_.y != var_2098 || _loc4_.z != var_2093 || param1.scale != var_2099))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_679);
               _loc7_ = _loc6_.z;
