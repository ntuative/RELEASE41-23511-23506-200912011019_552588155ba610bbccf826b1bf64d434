package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_733:int = 15;
      
      private static const const_1036:int = 2;
      
      private static const const_340:int = 2;
      
      private static const const_734:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_917[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_919[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_917 = new Array();
         var_917.push(Math.random() * _loc2_ * 1.5);
         var_917.push(Math.random() * _loc2_ * 1.5);
         var_916 = new Array();
         var_916.push(1);
         var_916.push(-1);
         var_918 = new Array();
         var_918.push(const_1036);
         var_918.push(const_1035);
         var_919 = new Array();
         var_919.push(getRandomAmplitudeFactor());
         var_919.push(getRandomAmplitudeFactor());
      }
