package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1108:int = const_301;
      
      public static const const_193:int = 2;
      
      public static const const_200:int = 3;
      ...
      public static const const_629:int = 6;
      
      public static const const_240:int = const_94;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1529 = param6;
         var_1528 = param7;
         var_758 = new Vector3d();
         if(var_1462 == const_629)
         {
            var_1250 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1480 == const_94)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_483);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_483,var_38.width,var_483);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.isEqual(var_758,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_483,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
