package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1086:int = 16777215;
      
      public static const const_1210:int = 10066329;
      
      private static const const_1084:int = 13421772;
      ...
      public static const const_1336:int = 13421772;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_108.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(var_85.getPlaneType(_loc4_) == RoomPlaneData.const_141)
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_675);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_528);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_723);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_964);
            if(_loc8_ != var_2084)
            {
               updatePlaneMasks(_loc8_);
               var_2084 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_710));
            if(_loc9_ != var_1005)
            {
               var_1005 = _loc9_;
            }
            var_2083 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_771));
         ...
         while(_loc4_ < var_108.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_173)
            {
               ...
               if(var_2083)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_1005 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_1005 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_1005 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_803);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_989);
         var _loc7_:int = 0;
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_108.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_220 || _loc3_.type == RoomPlane.const_173 && _loc8_ == RoomPlaneBitmapMaskData.const_212)
                  {
