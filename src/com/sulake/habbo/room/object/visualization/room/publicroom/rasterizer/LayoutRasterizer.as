package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_890:Point = null;
      
      private var var_430:Array;
      
      private var var_888:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_889 = param1;
         var _loc3_:LayoutRasterizerData = var_68.getValue(var_596);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1066 = RoomObjectVariableEnum.const_933;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1066 = RoomObjectVariableEnum.const_900;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_889 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_889 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_889 + _adBgIndex);
            _loc5_ = param1.getSprite(var_889 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1066);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1600);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_596)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_888 = var_68.getValue(var_596);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_68.getValue(var_596);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_888.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_890.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_890.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_313.indexOf(_loc10_) >= 0 && var_428)
            {
               ...
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_429[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_430[param1];
               }
               var_313.splice(param1,1);
               var_429.splice(param1,1);
               var_430.splice(param1,1);
               if(false)
               {
                  var_428 = false;
               }
