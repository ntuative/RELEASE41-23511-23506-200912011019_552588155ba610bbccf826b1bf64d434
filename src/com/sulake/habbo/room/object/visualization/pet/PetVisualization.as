package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_780:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_867);
         if(_loc11_ > 0)
         {
            ...
            if(_loc16_ < AvatarAction.const_815)
            {
               ...
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_885);
               var_485 = const_1096;
            }
         }
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_.getString(RoomObjectVariableEnum.const_244);
         switch(_loc13_)
         {
         ...
         var _loc14_:Boolean = var_275 != _loc2_.getUpdateID() || var_207 != param1.scale || var_184 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_485 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_485;
            if(var_514 != _loc6_)
            {
               for each(_loc35_ in var_384.getKeys())
               {
                  var_384.remove(_loc35_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_278);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_244);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_601);
            _loc5_.appendAction(AvatarAction.const_552,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_446);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc37_ = _loc3_.getNumber(RoomObjectVariableEnum.const_386);
               _loc38_ = 3;
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_355) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1068;
            ...
            {
               _loc28_ = null;
               _loc28_ = var_780.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
      ...
      {
         var_780 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
