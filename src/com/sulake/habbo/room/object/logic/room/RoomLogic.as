package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1482:int = 1500;
      
      private var var_1483:int = 255;
      
      private var var_1484:int = 255;
      
      private var var_1252:uint = 16777215;
      
      private var var_998:uint = 16777215;
      
      protected var var_85:RoomPlaneParser = null;
      
      private var var_820:int = 0;
      
      private var var_1202:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_656:
                  _loc2_.setString(RoomObjectVariableEnum.const_528,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_599:
                  _loc2_.setString(RoomObjectVariableEnum.const_675,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_499:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_445:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_212)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_495:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_964,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_771,int(_loc5_.bgOnly));
            var_1252 = _color;
            var_1483 = var_1202;
            var_998 = _loc11_;
            var_1484 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_803,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_85.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_92,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1151,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1236,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1317,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_92,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_140 || _loc13_ == RoomPlaneData.const_265)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_820)
         {
            ...
            {
               _loc6_ = var_1252 >> 16 & 255;
               _loc7_ = var_1252 >> 8 & 255;
               _loc8_ = var_1252 & 255;
               _loc9_ = var_998 >> 16 & 255;
               _loc10_ = var_998 >> 8 & 255;
               _loc11_ = var_998 & 255;
               _loc12_ = (_loc1_ - var_820) / var_1482;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1483 + (var_1484 - var_1483) * _loc12_;
               _color = _loc2_;
               var_1202 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_710,_loc2_);
         }
      }
   }
}
