package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1091:IScrollbarWindow;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_380:
                  _loc4_ = var_1092.clone();
                  if(var_509 != null)
                  {
                     var_509.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_509,var_1091,var_1287);
                  }
                  break;
               ...
               case Offer.const_425:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_303:
                        ...
                        _loc4_ = new BitmapData(var_92.width,var_92.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_305,AvatarAction.const_684);
                              _loc13_.appendAction(AvatarAction.const_720,_loc6_.productClassId);
      ...
      {
         var_1116 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1115 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1346 = new Point(var_92.x,var_92.y);
         var_509 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1091 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_509 == null)
         {
         ...
         var_1092 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_92);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_92.bitmap = new BitmapData(var_92.width,var_92.height,true,16777215);
         }
         var_92.bitmap.fillRect(var_92.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_92.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_92.invalidate();
         var_92.x = var_1346.x;
         var_92.y = var_1346.y;
         if(param2 != null)
