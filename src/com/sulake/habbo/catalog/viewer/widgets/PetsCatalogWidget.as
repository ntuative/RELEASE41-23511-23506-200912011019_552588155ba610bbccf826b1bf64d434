package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_395 >= var_299.length)
         {
            return "";
         }
         var petColor:IPetColor = var_299[var_395] as IPetColor;
         var color:uint = petColor.rgb;
         var p:String = _name + String.fromCharCode(10) + addZeroPadding(String(var_1466),3) + String.fromCharCode(10) + addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_395 = param1.index;
         if(var_395 < 0 || var_395 > var_299.length)
         {
            var_395 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_879.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_235,onTextWindowEvent);
         var_879 = new Map();
         ...
         var_813 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_997 = 0;
         var_299 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_813);
               if(_loc11_)
               {
                  var_997 = _loc11_.breeds.length;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_997)
         {
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_813,_loc6_),getRaceLocalizationKey(var_813,_loc6_)));
            _loc6_++;
         }
         var_879.add(var_813,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_971,onApproveNameResult);
         _loc5_ = var_879.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc1_:Offer = var_879.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_395 >= 0 && var_395 < var_299.length)
         {
            _loc6_ = var_299[var_395] as IPetColor;
            if(_loc6_ != null)
            {
               _loc2_ = uint(_loc6_.rgb);
            }
         }
         var _loc3_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_813,var_1466,_loc2_,AvatarScaleType.const_50);
         if(_loc3_ == null)
         {
            return;
         }
         _loc3_.initActionAppends();
         _loc3_.appendAction(AvatarAction.const_305,AvatarAction.const_621);
