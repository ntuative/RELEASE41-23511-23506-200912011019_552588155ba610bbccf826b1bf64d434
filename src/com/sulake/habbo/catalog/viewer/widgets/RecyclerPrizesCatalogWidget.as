package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1694:XML;
      
      private var var_289:IGridItem;
      
      private var var_1287:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_731:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_606.length)
         {
            createLevelItem(var_606[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_731 = new PrizeViewer();
         var_879 = new Map();
         var_606 = recycler.getPrizeTable();
         if(var_606 == null)
         {
            return;
         }
         ...
         var_1694 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_606[0].prizes.length > 0)
         {
            select(var_606[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1694) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_731.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
