package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_566[var_1007] as Array;
      ...
      {
         var _loc2_:Offer = var_566[var_1007][var_2091];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_459 || _loc1_.pricingModel == Offer.const_425)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_136 || _loc3_.productType == ProductTypeEnum.const_159)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_1006.indexOf(_loc5_) == -1)
                        {
                           var_1006.push(_loc5_);
                           var_566.push(new Array());
                        }
                        _loc6_ = var_1006.indexOf(_loc5_);
                        (var_566[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_566)
         {
            if(var_2091 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2091] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1007 = var_860.getGridItemIndex(param1.view);
