package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1348:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1301:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_856:String;
      
      private var var_1281:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_731:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_856);
      }
      ...
      {
         var _loc2_:String = const_1348 + param1;
         ...
         var_1301 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1301) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1109) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1281;
            _loc2_.init();
         }
         var_1281.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1281.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_856);
      }
