package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2231:String = "magic.pixels";
      
      private var var_2230:String = "catalog.page.club";
      
      private var var_2229:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_654,activateScrollbar);
      ...
      {
         var_71.openCatalogPage(var_2230,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_71.loadCatalogPage(param1.pageId);
         var_71.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_71.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_71.loadCatalogPage(_loc2_.pageId);
         }
