package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_186:Purse;
      
      private var var_1527:Boolean = true;
      ...
      private var var_583:PurchaseConfirmationDialog;
      
      private var var_788:IHabboSoundManager;
      
      private var var_310:ICatalogViewer;
      
      private var var_1526:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_358:ICatalogNavigator;
      ...
      {
         return var_531.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_186.credits = _loc3_.balance;
         updatePurse();
         if(!var_1527 && var_788 != null)
         {
            var_788.playSound(HabboSoundTypesEnum.const_787);
         }
         var_1527 = false;
      }
      ...
      {
         return var_531.getFurnitureData(param1);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               var_1046 = param1.session.isPrivateRoom;
               if(var_90 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_358 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_186.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_186.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_583 == null)
            {
               var_583 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_583.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      {
         var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_358.buildCatalogIndex(_loc2_);
         if(var_877 != "")
         {
            var_358.openPage(var_877);
            var_877 = "";
         }
         else
         {
            var_358.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_310 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_310.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_186.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1526 && var_788 != null)
         {
            var_788.playSound(HabboSoundTypesEnum.const_891);
         }
         var_1526 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_186.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_186.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_186.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_186.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_310.getCurrentLayoutCode();
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_310.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_310.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_310 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
