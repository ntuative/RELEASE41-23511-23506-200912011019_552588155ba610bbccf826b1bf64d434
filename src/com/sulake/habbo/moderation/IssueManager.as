package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_616:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_147 = new Map();
         var_855 = new Map();
         var_572 = new IssueBrowser(this,var_63.windowManager,var_63.assets);
         var_693 = [];
         var_854 = [];
         var_1024 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1024.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_693 = var_693.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_855.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_855.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1191)
         {
            var_158.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_147)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_855.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_855.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_139)
         {
            ...
            _loc8_ = var_854.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1024.remove(param1);
         var_1024.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_1024.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_63.soundManager.playSound(HabboSoundTypesEnum.const_907);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_855.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_147.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
