package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1238:int = 7;
      
      public static const const_865:int = 3;
      
      public static const const_1277:int = 8;
      
      public static const const_800:int = 5;
      ...
      {
         var_1319 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1319[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1319[param1] = _loc2_;
         }
         return _loc2_;
      }
