package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_766:int = 31536000;
      
      private static const const_764:int = 86400;
      
      private static const const_765:int = 3600;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_765) + " hours ago";
         }
         if(param1 < 2 * const_766)
         {
            return Math.round(param1 / const_764) + " days ago";
         }
         return Math.round(param1 / const_766) + " years ago";
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_853.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_55.getXmlWindow("user_info"));
            var_853.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ModActionCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_1022,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_55,WindowTracker.const_800,_data.userId),_callerFrame,var_1022,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new RoomVisitsCtrl(var_55,_data.userId),_callerFrame,var_1022,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new SendMsgsCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_1022,false,true);
      }
