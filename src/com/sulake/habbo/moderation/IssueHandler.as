package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_373:UserInfoCtrl;
      
      private var var_63:ModerationManager;
      
      private var var_946:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.releaseBundle(var_156.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_373 = new UserInfoCtrl(_window,var_63);
         var_946 = new UserInfoCtrl(_window,var_63);
         var_373.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_156.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_946.load(_loc3_,var_156.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_156.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_156.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_156.getHighestPriorityIssue().issueId;
         var_63.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_63,WindowTracker.const_865,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_63 != null && false && var_156 != null)
         {
            var_63.issueManager.removeHandler(var_156.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_373 = new UserInfoCtrl(_window,var_63);
            var_373.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_156.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_63.issueManager.closeBundle(var_156.id,3);
         checkAutoHandling();
         dispose();
      }
