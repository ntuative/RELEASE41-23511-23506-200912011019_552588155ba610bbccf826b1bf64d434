package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1409:IIssueBrowserView;
      
      private const const_1556:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1555:String = "picked_issues";
      ...
      private const const_1554:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_222:ITabContextWindow;
      
      private var var_1410:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_336.view.width = var_222.container.width;
         var_336.view.height = var_222.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1554:
               if(var_1408 == null)
               {
                  var_1408 = new MyIssuesView(issueManager,this,var_222.container);
               }
               return var_1408;
            case const_1556:
               if(var_1409 == null)
               {
                  var_1409 = new OpenIssuesView(issueManager,this,var_222.container);
               }
               return var_1409;
            case const_1555:
               if(var_1410 == null)
               {
                  var_1410 = new PickedIssuesView(issueManager,this,var_222.container);
               }
               return var_1410;
            default:
               return null;
