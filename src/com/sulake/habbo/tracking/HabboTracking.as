package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_393:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_991:int = -1;
      
      private var var_1234:LagWarningLogger = null;
      
      private var var_806:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_229 = new LatencyTracker();
         var_1234 = new LagWarningLogger();
         var_1233 = new Array(const_753);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1101,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1249,Capabilities.serverString);
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_619:
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_229 != null)
            {
               var_229.communication = _communication;
      ...
      {
         var_71 = IHabboCatalog(param2) as IHabboCatalog;
         var_71.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_71.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_71.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_177)
         {
            ...
            if(var_229 != null)
            {
               var_229.configuration = var_177;
            }
            if(var_228 != null)
            {
               var_228.configuration = var_177;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_475.events.addEventListener(AdEvent.const_448,onRoomAdLoad);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_619,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_690,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_57,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_450,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_453:
               var_1234.registerWarning(LagWarningLogger.const_887);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_806)
            {
               var_806.release(new IIDHabboWindowManager());
               var_806 = null;
            }
            if(var_475)
            {
               var_475.release(new IIDHabboAdManager());
               var_475 = null;
            }
            if(_navigator)
            {
            ...
            if(var_71)
            {
               if(true)
               {
                  var_71.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_71.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_71.release(new IIDHabboCatalog());
               var_71 = null;
            }
            if(var_28)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_280,onFriendlistTrackingEvent);
               }
            ...
            if(var_393)
            {
               if(true)
               {
                  var_393.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_393.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_393.release(new IIDHabboHelp());
               var_393 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_453,onLagWarningEvent);
               }
            }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_9,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_393 = param2 as IHabboHelp;
         var_393.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_393.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_23,onCoreRunning);
         }
      }
      ...
      {
         var_806 = IHabboWindowManager(param2);
         if(var_806)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_991 > -1 && _loc2_ < var_991)
         {
            ++var_1455;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1455);
         }
         if(var_991 > -1 && _loc2_ - var_991 > 15000)
         {
            ++var_1456;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1456);
         }
         var_991 = _loc2_;
         if(var_228 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_453,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_242,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_280,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_9,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_690)
         {
            trackLoginStep(HabboLoginTrackingStep.const_12);
         }
         else if(param1.type == HabboHotelViewEvent.const_450)
         {
