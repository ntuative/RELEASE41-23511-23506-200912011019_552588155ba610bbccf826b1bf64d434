package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1084));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1342[var_1084]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_250.width,var_250.height);
         var_250.x = _loc2_.x;
         var_250.y = _loc2_.y;
         var_1342[var_1084] = var_250;
      }
   }
}
