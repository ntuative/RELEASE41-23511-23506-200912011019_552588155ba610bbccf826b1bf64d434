package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         var_397.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = true;
         for each(_loc2_ in var_470)
         {
            _loc1_ = !_loc1_;
            var_397.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_139)
            {
               _loc1_++;
            }
         }
      ...
      {
         var_470.push(param1);
         var_397.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc3_ in var_470)
         {
            if(!param1 || _loc3_.state != FriendRequest.const_139)
            {
               _loc2_.push(_loc3_);
            }
         }
         ...
         {
            Util.remove(var_470,_loc4_);
            if(false)
            {
               var_397.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
