package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1408:int = "F".charCodeAt(0);
      
      public static const const_1400:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_514 = param1.figure;
         var_1177 = param1.motto;
         var_1176 = param1.lastAccess;
         var_1175 = param1.categoryId;
         var_1174 = param1.realName;
