package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1522:IAvatarRenderManager;
      
      private var var_1302:AvatarSearchResults;
      
      private var var_144:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_700:FriendRequests;
      
      private var var_1525:int;
      
      var var_326:FriendCategories;
      
      private var var_205:IHabboToolbar;
      
      private var var_1523:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_403:FriendListTabs;
      
      private var var_1524:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1303:OpenedToWebPopup;
      ...
      {
         var_1523 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_326 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1302 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1303 == null)
         {
            var_1303 = new OpenedToWebPopup(this);
         }
         var_1303.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_700.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_700.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_403.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_700.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_326.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_700 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.method_8);
         for each(_loc3_ in _loc2_.categories)
         {
            var_326.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_326.addCategory(new FriendCategory(FriendCategory.const_904,getText("friendlist.friends")));
         var_326.addCategory(new FriendCategory(FriendCategory.const_454,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_326.addFriend(new Friend(_loc4_));
         }
         var_403 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_123,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_326.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1522.createAvatarImage(param1,AvatarScaleType.const_91);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1522 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_700.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_403.findTab(FriendListTab.const_93);
      ...
      {
         var_1524 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_326.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_403.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1302.searchReceived(_loc2_.friends,_loc2_.others);
