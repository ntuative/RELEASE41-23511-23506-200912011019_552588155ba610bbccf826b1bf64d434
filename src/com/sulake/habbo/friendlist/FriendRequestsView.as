package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1354:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_309 && _loc4_.state != FriendRequest.const_321)
            {
      ...
      {
         var_1322 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1323 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1323.procedure = onDismissAllButtonClick;
         var_1322.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_321;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_139)
         {
         ...
         else if(param1.state == FriendRequest.const_321)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1322,_loc1_);
         setEnabled(var_1323,_loc1_);
      }
