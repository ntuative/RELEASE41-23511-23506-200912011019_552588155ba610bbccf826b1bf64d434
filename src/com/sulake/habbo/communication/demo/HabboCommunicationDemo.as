package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1936:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1331:ILogger;
      
      private var var_1207:String;
      
      private var var_1935:String;
      
      private const const_1372:String = "fuselogin";
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1934)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_656 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_656);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1207,var_1935));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1372,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1936);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1372,"/");
      ...
      {
         var_656 = _habboConfiguration.getKey("sso.ticket",null);
         var_1207 = _habboConfiguration.getKey("flash.client.url","");
         var_1935 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_171 == null)
         {
         ...
         if(var_656 != null)
         {
            var_77.mode = HabboConnectionType.const_390;
            var_77.initConnection(HabboConnectionType.const_225);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1331 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_619);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1936 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_77.mode)
         {
            case HabboConnectionType.const_390:
               _loc6_ = "";
               ...
               var_979 = _loc4_;
               var_171.loadBannerImage(_loc7_ + "?token=" + var_979,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1212:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1244:
               var_981 = generateRandomHexString(30);
      ...
      private function onWindowManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         queueInterface(new IIDHabboConfigurationManager(),method_6);
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_979);
         ...
         while(_loc12_.length < 64)
         {
            var_981 = generateRandomHexString(30);
            var_474.init(var_981);
            _loc12_ = var_474.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
