   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_450));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_652.loadAssetFromFile("hotel_view_banner_" + var_778,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_690));
            }
            var_182 = param2;
