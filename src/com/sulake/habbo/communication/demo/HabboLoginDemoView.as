package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_608:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_346.shockwaveClientUrl = var_120.shockwaveClientUrl;
         var_346.ssoTicket = var_120.ticket;
         var_120.removeEventListener(SSOTicket.const_286,onParsedTicketSuccess);
         var_120.removeEventListener(SSOTicket.const_266,onParsedTicketFailure);
         var_120 = null;
         dispatchEvent(new Event(const_608));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1372,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_346.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_329,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1372,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_120 = new SSOTicket(var_346.assets,_loc2_,_loc1_);
         var_120.addEventListener(SSOTicket.const_286,onParsedTicketSuccess);
         var_120.addEventListener(SSOTicket.const_266,onParsedTicketFailure);
      }
