package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1001:Number = 90;
      
      private static const const_737:int = 50;
      
      private static const const_999:Number = 25;
      ...
      private var var_930:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_930 = param2;
         var_529 = new Timer(const_999);
         var_529.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_449.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_449.splice(_loc3_,1);
            var_448.splice(_loc3_,1);
         }
         var_448.push(param1.name);
         var_449.push(param2);
         param1.addEventListener(WindowEvent.const_400,windowEventListener);
         param1.addEventListener(WindowEvent.const_185,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_449[var_448.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_930.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_930.getIconLoc(param1.iconId);
      ...
      {
         return var_448[var_449.indexOf(param1)];
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_530[_loc3_] = new Array();
            }
            if(var_530[_loc3_].indexOf(param1) < 0)
            {
               var_530[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_737 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_737 || param1.desktop.height - param1.y < const_1046;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_448[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_530[_loc3_].length)
                  {
                     repositionWindow(var_530[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
