package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_801:Number = 32;
      ...
      private var var_2226:Number = 500;
      ...
      private var var_2225:Number = -500;
      ...
      {
         if(var_385 != param1 * var_1440)
         {
            var_385 = param1 * var_1440;
            ++var_84;
         }
      }
      ...
      {
         if(var_387 != param1 * var_1439)
         {
            var_387 = param1 * var_1439;
            ++var_84;
         }
      }
      ...
      {
         if(var_388 != param1 * var_1441)
         {
            var_388 = param1 * var_1441;
            ++var_84;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_386 != null)
         {
            ...
            var_386.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_386.add(_loc3_,_loc4_);
            ++var_84;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_986.assign(_loc22_);
         }
         else
         {
            var_986.assign(_loc17_);
         }
         ++var_84;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_78);
         _loc2_.x *= var_387;
         _loc2_.y *= var_388;
         _loc2_.z *= var_385;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_986);
         if(_loc3_ < var_2225 || _loc3_ > var_2226)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_78);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_387;
            _loc2_.y *= var_388;
            _loc2_.z *= var_385;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_986);
         }
      ...
      {
         return new Vector3d(0 * var_387,0 * var_388,0 * var_385);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_78.y = 0 / var_388;
         var_78.z = 0 / var_385;
         if(var_78.x != _loc2_ || var_78.y != _loc3_ || var_78.z != _loc4_)
         {
            ++var_84;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_386 != null)
         {
            ...
            return var_386.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_387,0 * var_388,0 * var_385);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_387,param2.y * var_388,param2.z * var_385);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_387,param3.y * var_388,param3.z * var_385);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_387,param4.y * var_388,param4.z * var_385);
