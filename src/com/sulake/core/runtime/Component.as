package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1522:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_1131:uint = 4;
      ...
      protected var var_183:InterfaceStructList;
      
      protected var var_2145:String = "";
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1042 = param2;
         var_183 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_183.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(var_1042 & const_1131)
         {
            if(_loc3_ == 0)
            {
               if(var_183.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_183.getStructByIndex(_loc8_);
