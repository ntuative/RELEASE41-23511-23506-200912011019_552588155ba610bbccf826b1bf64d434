package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1135:String = "AssetLibraryUnloaded";
      
      public static const const_426:String = "AssetLibraryLoaded";
      
      public static const const_1296:String = "AssetLibraryLoadError";
       
      
      private var var_465:XML;
      
      private var var_379:Dictionary;
      
      private var var_335:Array;
      
      private var var_198:uint;
      ...
      public function unload() : void
      {
         ...
         var_290 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1135));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_465 = _loc2_.manifest.copy();
         var_334 = _loc2_.resource;
         if(var_464)
         {
            AssetLibrary.fetchLibraryContents(this,var_465,var_334);
         }
         var_290 = true;
         dispatchEvent(new Event(AssetLibrary.const_426));
         if(var_464)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_871,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_957.splice(var_957.indexOf(this),1);
            --var_544;
            var_380 = null;
            var_643 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1296));
      }
      ...
      {
         var _loc2_:Class = var_643[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_865);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_465.child("library");
         if(_loc2_ == null)
         {
