package com.sulake.core.communication.encryption
{
   ...
   public class RC4 implements IEncryption
   {
      ...
      public function method_10(param1:ByteArray) : ByteArray
      {
         var _loc3_:int = 0;
      ...
      {
         var _loc3_:Object = var_116[param1];
         var_116[param1] = var_116[param2];
         var_116[param2] = _loc3_;
      }
      ...
      public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(param2)
            {
               customHackScramble(var_116,i,j);
            }
            _loc4_ = 0;
      ...
      public function init(param1:ByteArray) : void
      {
         ...
         while(i < 256)
         {
            j = (j + var_116[i] + param1[i % _loc2_]) % 256;
            swap(i,j);
            ++i;
         }
         i = 0;
