package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1098:int = 10000;
      ...
      private var var_620:IEncryption;
      
      private var var_619:int;
      
      private var var_319:ByteArray;
      ...
      private var var_318:IConnectionStateListener;
      
      private var var_524:IProtocol;
      
      private var var_748:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         _id = param1;
         var_618 = param2;
         var_319 = new ByteArray();
         var_748 = new MessageClassManager();
         var_193 = new Socket();
         var_320 = new Timer(const_1098,1);
         var_320.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_748.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         ...
         if(var_318)
         {
            var_318.messageSent(_loc5_.toString());
         }
         if(var_620 != null)
         {
            _loc3_ = var_620.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(var_318)
         {
            var_318.connectionInit(param1,param2);
         }
      ...
      {
         var_618.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         while(false)
         {
            var_319.writeByte(var_193.readUnsignedByte());
         }
      }
      ...
      {
         var_748.registerMessages(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_524.getMessages(var_319,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            if(var_318)
            {
               var_318.messageReceived(_loc5_ + " " + _loc6_);
            }
            _loc7_ = var_748.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_618.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_618.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_319,_loc2_);
            var_319 = _loc18_;
         }
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_620 + "\n");
      }
   }
}
