package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      protected var var_575:Function;
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(_loc13_ != null)
         {
            var_355 = new Rectangle(0,0,int(_loc13_.attribute("width")),int(_loc13_.attribute("height")));
            var_60 = var_355.clone();
            var_22 = var_355.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_135);
         var _loc2_:* = !testParamFlag(WindowParam.const_112,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_31 & 0);
               if(_loc5_ == WindowParam.const_221)
               {
      ...
      {
         var_5 = param1;
         var_419 = !!var_5 ? uint(var_419 | _alphaColor) : uint(var_419 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_69);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_350)
         {
            return true;
         }
         _state = WindowState.const_350;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1768 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1127:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1146:
               _loc2_ = "null";
               break;
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_987);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_928 || _loc3_.hasGraphicsContext())
         {
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_492);
      }
      
      public function set color(param1:uint) : void
      {
         _alphaColor = param1 & 4278190080;
         var_419 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_69);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_542))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_816;
                  if(testParamFlag(WindowParam.const_318))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_239:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_160,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_168,WindowParam.const_143))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_228,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_351:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_473);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_958,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_233,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_291:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_707,this,null));
                     if(var_23 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_378:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_841);
                  break;
               case WindowNotifyEvent.const_344:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_434:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_473);
                     }
                  }
                  else if(var_31 & 0)
                  {
               ...
               case WindowNotifyEvent.const_195:
                  ...
                  break;
               case WindowNotifyEvent.const_460:
                  var_23.getRegionProperties(null,var_285);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_300:
      ...
      {
         return var_575 != null ? var_575 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_492);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_555,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_514;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_928 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_348)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_976,this,null,true);
               update(this,_loc10_);
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_378,this,null));
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_60,true);
         _loc1_.type = WindowNotifyEvent.const_1150;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_306 && var_492 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1381,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1381,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_285 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_397,this,var_23));
            }
            else
            {
               var_285.x = 0;
               ...
               var_285.width = 0;
               var_285.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_842,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_239,_type,var_87,var_31,_context,var_22,null,var_575,properties,var_577.concat(),_id) as WindowController;
         _loc2_.var_492 = var_492;
         _loc2_.var_306 = var_306;
         _loc2_.var_865 = var_865;
         _loc2_.var_285 = var_285.clone();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1332,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_60,false);
         _loc1_.type = WindowNotifyEvent.const_1313;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_593;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_492 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_789,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
