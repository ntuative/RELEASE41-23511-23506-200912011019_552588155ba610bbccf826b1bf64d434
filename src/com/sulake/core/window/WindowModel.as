package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_699:Boolean;
      
      protected var var_148:Rectangle;
      
      protected var var_419:uint;
      
      protected var _state:uint;
      
      protected var var_87:uint;
      
      protected var var_315:Boolean;
      ...
      public function WindowModel(param1:uint, param2:String, param3:String, param4:uint, param5:uint, param6:uint, param7:WindowContext, param8:Rectangle, param9:Array = null)
      {
         ...
         var_87 = param5;
         var_577 = param9 == null ? new Array() : param9;
         var_239 = param3;
         _context = param7;
         var_22 = param8.clone();
         var_355 = param8.clone();
         var_60 = param8.clone();
