package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1542:String = "_INCLUDE";
      
      public static const const_883:String = "_EXCLUDE";
      
      public static const const_1496:String = "_TEMP";
      
      private static const const_1016:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1015:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1036:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_864:Dictionary;
      
      protected var var_1290:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1291:Dictionary;
      
      protected var var_1035:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1035,var_1036);
         var_864 = new Dictionary();
         var_1291 = new Dictionary();
         ParamCodeTable.fillTables(var_864,var_1291);
         var_1290 = new Map();
      }
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1016,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1035)
            {
               delete var_1035[_loc1_];
            }
            for(_loc1_ in var_1036)
            {
               delete var_1036[_loc1_];
            }
            for(_loc1_ in var_864)
            {
               delete var_864[_loc1_];
            }
            for(_loc1_ in var_1291)
            {
               delete var_1291[_loc1_];
            }
            var_1290.dispose();
            var_1290 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         background = method_1(xml,"background",variables,background.toString()) == "true";
         treshold = uint(method_1(xml,"treshold",variables,treshold.toString()));
         visible = method_1(xml,"visible",variables,visible.toString()) == "true";
         clipping = method_1(xml,"clipping",variables,clipping.toString()) == "true";
         caption = unescape(method_1(xml,"caption",variables,caption));
         color = method_1(xml,"color",variables,color);
         blend = Number(method_1(xml,"blend",variables,blend.toString()));
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_883) == -1)
                  {
