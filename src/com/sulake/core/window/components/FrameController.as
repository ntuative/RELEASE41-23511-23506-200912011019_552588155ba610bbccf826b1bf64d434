package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_992:String = "_TITLE";
      
      private static const const_993:String = "_CONTENT";
      
      private static const const_995:String = "_HEADER";
      
      private static const const_994:String = "_SCALER";
      ...
      private var var_1050:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1050 == null)
         {
            var_1050 = findChildByTag(const_995) as IHeaderWindow;
            if(!var_1050)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_992) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_994) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_226,false);
         }
      ...
      {
         return content != null && var_1288 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_993) as IWindowContainer;
            if(!var_33)
            {
