package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_491:String = "none";
      
      protected var var_574:Number;
      
      protected var var_352:Number;
      
      protected var _field:TextField;
      
      protected var var_696:Boolean = false;
      ...
      {
         return new Rectangle(var_574 * maxScrollH,var_352 * maxScrollV,width,height);
      }
      ...
      {
         var_574 = param1;
         _field.scrollH = var_574 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            _PROPERTY_SETTER_TABLE = method_3();
         }
      ...
      private function method_3() : Dictionary
      {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_267,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1305,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_404,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_267,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_404,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_267,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_490,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_267,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_490,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_73.left,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_top",var_73.top,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_right",var_73.right,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_73.bottom,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("auto_size",var_491,PropertyStruct.const_267,var_491 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_490,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_491 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_491 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_491 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_491 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
