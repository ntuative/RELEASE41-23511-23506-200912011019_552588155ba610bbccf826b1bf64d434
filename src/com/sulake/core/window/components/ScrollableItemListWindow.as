package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1478:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_344)
         {
            ...
            if(var_344)
            {
               var_344.addEventListener(WindowEvent.const_255,scrollBarEventProc);
               var_344.addEventListener(WindowEvent.const_185,scrollBarEventProc);
            }
         }
         return var_344;
      }
      ...
      override public function dispose() : void
      {
         if(var_344)
         {
            var_344.removeEventListener(WindowEvent.const_255,scrollBarEventProc);
            var_344.removeEventListener(WindowEvent.const_185,scrollBarEventProc);
            var_344 = null;
         }
         if(_cachedItemList)
         {
