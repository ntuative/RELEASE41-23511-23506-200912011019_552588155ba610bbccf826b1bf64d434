package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1077:uint = 8;
      ...
      private var var_2003:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2003 = new Dictionary();
         TypeCodeTable.fillTables(var_1454,var_2003);
         var_1232 = new Dictionary();
         var_2002 = new Dictionary();
         StateCodeTable.fillTables(var_1232,var_2002);
         ...
         {
            var_357 = new Array();
            var_357.push(WindowState.const_60);
            var_357.push(WindowState.const_67);
            var_357.push(WindowState.const_88);
            var_357.push(WindowState.const_47);
            var_357.push(WindowState.const_73);
            var_357.push(WindowState.const_70);
            var_357.push(WindowState.const_89);
            var_357.push(WindowState.const_76);
         }
         ...
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1454[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_560[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_560[param1] = new Array(SkinContainer.const_1077);
         }
         var_560[param1][param2] = param3;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_560)
         {
            ISkinRenderer(var_560[_loc1_]).dispose();
            delete var_560[_loc1_];
         }
