package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1197,error);
         }
      }
      ...
      {
         initCore("config_habbo.xml",Core.const_781);
      }
      ...
      private function prepareBakedInComponent(param1:Class) : void
      {
         ...
         var_873.prepareComponent(manifest,resource);
      }
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_873 = Core.instantiate(this,param2);
         initBakedInComponents();
         var_873.events.addEventListener(Component.COMPONENT_EVENT_ERROR,onCoreError);
         var_873.loadExternalConfigDocument(new URLRequest(param1),var_1519);
      }
   }
}
